...
contract ReserveConsumerV3 {
     ...
     * Aggregator: WBTC PoR
     * Address: 0xa81FE04086865e63E12dD3776978E49DEEa2ea4e - will be changed to REUR PoR later
     */
    constructor() {
        reserveFeed = AggregatorV3Interface(
            0xa81FE04086865e63E12dD3776978E49DEEa2ea4e // will be changed to REUR PoR later
        );
    }
